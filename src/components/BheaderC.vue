<template>
  <div class="bg-gray-300 p-3 flex items-center fixed w-full z-10 top-0 left-0">
    <div class="ml-16">
    ...
    <div class="ml-20 flex gap-4">
      ...
      <img src="./Icons/Icon material-keyboard-arrow-down.svg" alt="" />
    ...
    <div class="ml-auto pr-16 flex gap-4">
